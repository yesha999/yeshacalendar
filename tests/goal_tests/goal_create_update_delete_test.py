...
class TestCreateUpdateDelete:
    ...
    def test_board_create(self, client, header):
    ...
    def test_board_update(self, client, header):
    ...
    def test_board_detail_by_participat(self, client, header):
        create_board = client.post("/goals/board/create", data={"title": "test board title"},
                                   content_type="application/json", headers=header)  # создаем доску
        participant = User.objects.create_user(username="board_participant", password="Test1234",
                                               email="test@test.test")  # создаем юзера для проверки дополнения участников
    ...
    def test_board_update_not_owner(self, client, header):
        create_board = client.post("/goals/board/create", data={"title": "test board title"},
                                   content_type="application/json", headers=header)  # создаем доску
        participant = User.objects.create_user(username="board_participant", password="Test1234",
                                               email="test@test.test")  # создаем юзера для проверки дополнения участников
    ...
    def test_board_delete(self, client, header):
        create_board = client.post("/goals/board/create", data={"title": "test board title"},
                                   content_type="application/json", headers=header)  # создаем доску
    ...
    def test_board_delete_not_owner(self, client, header):
        create_board = client.post("/goals/board/create", data={"title": "test board title"},
                                   content_type="application/json", headers=header)  # создаем доску
    ...
    def test_goal_category_create(self, client, header):
        create_board = client.post("/goals/board/create", data={"title": "test board title"},
                                   content_type="application/json", headers=header)
    ...
    def test_goal_category_update(self, client, header):
        create_board = client.post("/goals/board/create", data={"title": "test board title"},
                                   content_type="application/json", headers=header)
        data = {"title": "test category name", "board": create_board.data["id"]}
        post_response = client.post("/goals/goal_category/create", data=data, content_type="application/json",
    ...
    def test_goal_category_delete(self, client, header):
        create_board = client.post("/goals/board/create", data={"title": "test board title"},
                                   content_type="application/json", headers=header)
        data = {"title": "test category name", "board": create_board.data["id"]}
        post_response = client.post("/goals/goal_category/create", data=data, content_type="application/json",
    ...
    def test_goal_category_update_by_participant(self, client, header):
        create_board = client.post("/goals/board/create", data={"title": "test board title"},
                                   content_type="application/json", headers=header)
    ...
    def test_goal_category_delete_by_participant(self, client, header):
        create_board = client.post("/goals/board/create", data={"title": "test board title"},
                                   content_type="application/json", headers=header)
        data = {"title": "test category name", "board": create_board.data["id"]}
        post_response = client.post("/goals/goal_category/create", data=data, content_type="application/json",
    ...
    def test_goal_category_update_delete_by_participant_reader(self, client, header):
        create_board = client.post("/goals/board/create", data={"title": "test board title"},
                                   content_type="application/json", headers=header)
    ...
    def test_goal_create(self, client, header):
        create_board = client.post("/goals/board/create", data={"title": "test board title"},
                                   content_type="application/json", headers=header)
        ...
        assert get_response.data["user"]["id"] == 4
        assert get_response.data["title"] == data["title"]
        assert get_response.data["status"] == data["status"]

    def test_goal_update_delete(self, client, header):
        create_board = client.post("/goals/board/create", data={"title": "test board title"},
                                   content_type="application/json", headers=header)
        create_category = client.post("/goals/goal_category/create",
                                      data={"title": "test category name", "board": create_board.data["id"]},
